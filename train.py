...
def make_env():
    return Monitor(Wheat(year1=1982, year2=2007))


def train_ppo(timesteps: int, config: Config, output_dir: Path):
...
def plot_combined_rewards(timesteps_list: List[int], output_dir: Path):
