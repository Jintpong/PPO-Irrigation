...
class Wheat(gym.Env):
    def __init__(self, year1=1982, year2=2018, crop='Wheat', climate_file='champion_climate.txt', planting_date='01/01'):
        super().__init__()
        
        self.year_start, self.year_end = year1, year2
    ...
    def initialize_environment(self, seed=None, options=None):
        ...
        try:
            self.weather_df = prepare_weather(self.climate_file_path)
        except FileNotFoundError:
            raise FileNotFoundError(f"Cannot locate weather file: {self.climate_file_path}")
